...
model_name = "T5_wikitrasnfer_test_2"
...
t5_wiki_model = T5_Wiki(data_path, shared_docs_path, num_examples, wiki_path)
...
exp_runner.get_model_analysis(t5_wiki_model, num_trials, True, model_name, multi_processing=False)
